...
label c0_shooter_vodka_hit:
    ...
    "Колд неожиданно вопросил это у Вечного."
    "А Вечный задумался."
    "Хорошо так."
...
label c0_shooter_ohota_hit:
    ...
    cld "Ты мне чуть бошку не снёс пулей, ебанько."
    window hide
    ...
    "Колд подбадривал Вечного, ведь знал - за этим парнишей больше будущее, ахаха."
    "Вечный проверил боезапас и погнал шмалять со шпалера дальше."
...
label c0_shooter_essa_hit:
    ...
    pause 1.7
    "Первая тара из под эссе была успешно отстреляна, ёпта."
...
label c0_shooter_garage_hit:
    ...
    vchn "Как видишь."
    vchn "Неплохо."
    "У Вечного нет никакого желания отвлекаться и гутарить с Лордом."
...
label c0_shooter_huga_hit:
    ...
    play sound v_zaebis
    pause 0.7
    "Последняя тара из под хуги была отсреляна."
